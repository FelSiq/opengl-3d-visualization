...
#for i in materials.keys():
	#vetor.append(materials[i][0])

material = list (materials.keys())[1]
print(material+'\n')
print(materials[material][0])
print(materials[material][1])
print(materials[material][2])
print(materials[material][3])
